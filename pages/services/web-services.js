...
const techImage="../../public/icons/service-icon/Frame.png";
        ...
        <>
            {/* Service container body content */}
                    <div className='service-container-body-left-content-1'>
                        <p className='service-p service-para'>A fully-functional and highly interactive website is required for your business to keep things on the right track!
                    ...
                    <div className='service-container-body-left-content-2'>
                        <h2 className='service-h2'>Process we follow</h2>
                        <p className='service-p'>How Our Experts Handle The Project Efficiently</p>
                        <ol>
                            <li>
                                <p className='service-h3'>1) Planning</p>
                                <p className='service-p'>Gather all the information and plan the project, craft the idea for the website and CMS development.</p>
                            </li>
                            <li>
                                <p className='service-h3'>2) Web Designing</p>
                                <p className='service-p'>Our front-end designers will craft a stunning and striking responsive website following the wireframe, UI/UX design to prototype.</p>
                            </li>
                            <li>
                                <p className='service-h3'>3) Define Content</p>
                                <p className='service-p'>A website is incomplete without content. Thus, we will put informative content on the website and make it SEO-friendly.</p>
                            </li>
                            <li>
                                <p className='service-h3'>4) Development</p>
                                <p className='service-p'>After deciding the website's objectives, it is time for development. The process is the pre-final stage of the website.</p>
                            </li>
...
const content2=()=>(
    ...
    <div>
                ...
                <div className='service-container-body-left-content-3'>
                    <h2 className='service-h2'>The Technologies And Services We Use For Website & CMS Development</h2>
                    <p>Innovative and Advanced Technologies for the Website & CMS Development</p>

                    <h3 className='service-h3'>WordPress Web Development</h3>
                    <p className='service-para'>Our developer provides the best WordPress Web Development to create an efficient website.</p>
                </div>
    </>
)
