        ...
        <div className="roadmap__head">
          <div className="roadmap__wrap" data-aos="animation-scale-y">
            ...
            <h2 className="roadmap__title title">
              All systems are a go<span className="title__color">.</span>
            </h2>
            <div className="roadmap__info">
              Find out where we are on the path to achieving the ultimate design
              tool.
            </div>
          ...
          <div className="roadmap__view" data-aos>
            ...
            <div className="roadmap__bg">
              <img
                className="roadmap__pic js-parallax"
                data-scale="1.5"
                data-orientation="left"
                src="img/roadmap-pic-1.webp"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="roadmap__box">
            ...
            <div className="roadmap__lines">
              <div className="roadmap__line">
                <div className="roadmap__progress" data-aos>
                  Collab Community
                </div>
              </div>
              <div className="roadmap__line">
