  ...
  return (
    <>
      <div id="features" className="features js-features">
          ...
          <div className="features__head" data-aos="animation-scale-y">
            ...
            <div className="features__box">
              ...
              <div className="features__info info">
                Our services focus on Mobility Solutions, Web Application
                Development, Cloud Solutions, IoT, AR/VR, Blockchain, Artificial
                Intelligence & Machine Learning, Predictive Analytics & Big Data
                Solutions, and several other trending and emerging technologies.
              </div>
            </div>
          </div>
                    ...
                    <div className="features__details">
                      <div className="features__preview">
                        <img
                          ...
                          src="images/computer-front-color.webp"
                          alt=""
                        />
                      </div>
                      ...
                      <div className="features__text">
                        <p>
                          We develop User friendly and reliable applications
                          that helps to solve the problems in almost every
                          field.
                        </p>
                        <p>
                          Related Expertise:
                ...
                <div>
                  ...
                  >
                    <div className="features__details">
                      ...
                      <div className="features__text">
                        <p>
                          Not just mobile apps, we build user-friendly
                          Experiances.Apps that resolve real-life problems, that
                          got featured over store, and generate revenue.
                        </p>
                        <p>
                          {" "}
                          Related Expertise:{" "}
                ...
                <div>
                  <div className="features__slide">
                    <div className="features__details">
                      ...
                      <div className="features__text">
                        <p>
                          Do your business on E-commerce platforms and allow
                          your consumers/connected traders to buy things online.
                          Let us provide you best related solutions that will
                          bost up your business.
                        </p>
                        <p>
                          Related Expertise:
                          <span className="mint">
                ...
                <div>
                  <div className="features__slide">
                    <div className="features__details">
                      ...
                      <div className="features__text">
                        <p>
                          A Blockchain is secured by system design and is an
                          example of a distributed computing system.It is
                          suitable for the identity management transaction
                          processing. Yes, We have expertise to develop and take
                          care of secure distributed system.
                        </p>
                        <p>
                          Related Expertise:
                  ...
                  <div className="features__slide">
                    <div className="features__details">
                      ...
                      <div className="features__text">
                        <p>
                          {" "}
                          These kind of systems are of same standard and
                          functionalities in almost all the industires. Though
                          we prefer it platform based but also we develop custom
                          systems as per your requirements.{" "}
                        </p>
                        <p>
                          Related Expertise:
                          ...
                          >
                            <span className="cyclamen">
                              ...
                              Zoho/Salesfore CRM , Point Of Sale Systems,
                              Corporate CRM/ERP Systems
                            </span>
                            <br />
                            <a
                              href="#"
                    ...
                    <div className="features__details">
                      ...
                      <div className="features__text">
                        <p>
                          ...
                          use we are here to develop apps on best level.
                        </p>
                        <p>
                          {" "}
                          Related Expertise:
        ...
        <div
          className="features__circle js-rellax"
          data-rellax-speed="-.7"
        ></div>
