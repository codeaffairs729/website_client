        ...
        <div className="footer" style={{ overflow: "hidden" }}>
            <div className="footer__center center">
                <div className="footer__row pt-5">
                    <div onClick={() => showAboutUs()} className={ aboutUs ? "footer__col col-lg-4 col-md-4 active" : "footer__col col-lg-4 col-md-4"} >
                        <div className="footer__category footer-category-cgt-name">
                            Code Garage
                        ...
                        <div className="footer__menu" style={ aboutUs ? { display: "block" } : { display: "none" }} >
                            <span className="footer__link footer-link-about" >We’re a design driven product development studio.</span>
                    ...
                    <div onClick={() => showTechnologies()} className={ technologies ? "footer__col col-lg-4 col-md-4 active" : "footer__col col-lg-4 col-md-4"}>
                    ...
                    <div onClick={() => showSocialIcons()} className={ socialIcons ? "footer__col col-lg-4 col-md-4 active" : "footer__col col-lg-4 col-md-4" } >
                        <div className="footer__category">
                        ...
                        <div className="footer__menu footer-social-menu" style={ socialIcons ? { display: "flex" } : { display: "none" }} >
