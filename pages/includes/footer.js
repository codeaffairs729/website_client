                            ...
                            <div className={`footer__menu js-footer-menu ${technologies ? "" : "hide"}`} >
                                <div className='row' >
                                    ...
                                    <div className='col-lg-6 mb-4' >
                                        <div className='row' >
                                            <div className='col-lg-2 col-md-2 col-sm-2 col-xs-2 col-2 d-flex justify-content-center align-items-center' >
                                                <img className='footer-tech-img' src='/images/node_2.webp' alt='Nodejs PNG Image' />
                                            </div>
                                            <div className='col-lg-10 col-md-10 col-sm-10 col-xs-10 col-10' >
                                    ...
                                    <div className='col-lg-6 mb-4' >
                                        <div className='row' >
                                            <div className='col-lg-2 col-md-2 col-sm-2 col-xs-2 col-2 d-flex justify-content-center align-items-center' >
                                                <img className='footer-tech-img' src='/icons/reactjs.webp' alt='Reactjs Icon' />
                                            </div>
                                            <div className='col-lg-10 col-md-10 col-sm-10 col-xs-10 col-10' >
                                    ...
                                    <div className='col-lg-6 mb-4' >
                                        <div className='row' >
                                            <div className='col-lg-2 col-md-2 col-sm-2 col-xs-2 col-2 d-flex justify-content-center align-items-center' >
                                                <img className='footer-tech-img' src='/icons/laravel.webp' alt='Laravel Icon' />
                                            </div>
                                            <div className='col-lg-10 col-md-10 col-sm-10 col-xs-10 col-10' >
                            ...
                            <div className={`footer__menu js-footer-menu footer-social-menu ${socialIcons ? "" : "hide"}`} >
                                <Link href="https://www.facebook.com/codegaragetech">
                                    <a className="footer__link me-3" target='_blank'>
                                        <img className="icon icon-header-img" src="/images/Facebook3d.webp" alt="3D Facebook Icon" />
                                    </a>
                                </Link>
                                <Link href="https://twitter.com/codegaragetech">
                                    <a className="footer__link me-3" target='_blank'>
                                        <img className="icon icon-header-img" src="/images/Twitter3d.webp" alt="3D Twitter Icon" />
                                    </a>
                                </Link>
                                <Link href="https://www.linkedin.com/company/codegarage-tech/">
                                    <a className="footer__link me-3" target='_blank'>
                                        <img className="icon icon-header-img" src="/images/LinkedIn3d.webp" alt="3D LinkedIn Icon" />
                                    </a>
                                </Link>
                                <Link href="https://www.instagram.com/codegaragetech/">
                                    <a className="footer__link" target='_blank'>
                                        <img className="icon icon-header-img" src="/images/Instagram3d.webp" alt="3D Instagram Icon" />
                                    </a>
                                </Link>
                            </div>
                        </div>
