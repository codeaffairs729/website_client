        ...
        <div className="row career-area-3-outer-row border-top-5 p-5">
          ...
          <div className="col-lg-6 col-md-6 career-area-3-para d-flex align-items-center">
            <p>
              ...
              collaborative, diverse, and supportive team. At Code Garage Tech,
              we push the boundaries to make your career go boom!
            </p>
          </div>
          ...
          <div className="col-lg-6 col-md-6 d-flex align-items-center">
            <div className="career-area-8-text-div-1">
              ...
              <p className="career-area-8-para mt-3">
                ...
                productive and we at Code Garage Tech find fun in little things
                that make our day full of positive vibes. We Lift Spirits by
                making our office environment lively with great music. We
                believe that fun is essential to a good work environment. That's
                why we offer flexible hours, fun events, and challenging
                projects. We want you to feel like you're not just
                working—you're exuberant!
              </p>
            </div>
          </div>
