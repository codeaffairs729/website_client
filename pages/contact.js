  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Please fill out the contact form to get in touch with us for your Web and App development needs. Our sales representative will get back to you soon."
        />
      </Head>
      <ToastContainer
        position="top-right"
      ...
      <div className="page">
        <div className="entry entry_solo contact_solo">
            ...
            <div className="entry__head contact__head">
              <Link href="/">
                <div className="entry__logo contact__logo">
                  ...
                  />
                  <img
                    className="entry__pic entry__pic_black"
                    src="logo/cgt_new_logo_alt2.webp"
                    alt="CodeGarage Tech"
                  />
                </div>
              </Link>
                      ...
                      >
                        ...
                        <div className="entry__field field">
                          ...
                          <div className="field__wrap">
                            ...
                            <input
                              onFocus={() => changeNameIcon(1)}
                              onBlur={() => changeNameIcon(0)}
                              onChange={(e) => setName(e.target.value)}
                              className="field__input contact-field-input"
                              type="text"
                              name="name"
                              placeholder="Name"
                              value={name}
                        ...
                        <div className="entry__field field">
                          ...
                          <div className="field__wrap">
                            ...
                            <input
                              onFocus={() => changePhoneIcon(1)}
                              onBlur={() => changePhoneIcon(0)}
                        ...
                        <div className="entry__field field">
                          ...
                          <div className="field__wrap">
                            ...
                            <input
                              onFocus={() => changeEmailIcon(1)}
                              onBlur={() => changeEmailIcon(0)}
                        ...
                        <div className="entry__field field">
                          ...
                          <div className="field__wrap">
                            ...
                            <textarea
                              onFocus={() => changeMessageIcon(1)}
                              onBlur={() => changeMessageIcon(0)}
                              onChange={(e) => setMessage(e.target.value)}
                              className="field__input field_text_area"
                              name="message"
                              placeholder="Message"
                              value={message}
                              required
          ...
          <div className="entry__bg">
            <img
              className="entry__pic"
              src="img/entry-circle.webp"
              alt="Background Solid Blue Circle"
            />
          </div>
          <div className="contact__cloud heroku-floating">
            ...
            >
              <img
                className="tool__pic js-parallax"
                data-scale="1.5"
