...
const CompanyDescription = () => {
    ...
    const formFields = [
        ...
        },
        {
            icon: <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.5 2.5L8.43079 6.60593C8.77323 6.84301 9.22676 6.84301 9.56921 6.60593L15.5 2.5M3 13H15C16.1046 13 17 12.1046 17 11V3C17 1.89543 16.1046 1 15 1H3C1.89543 1 1 1.89543 1 3V11C1 12.1046 1.89543 13 3 13Z" stroke="#292930" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>,
            render: () => {
                return (<input
                    type="email"
        ...
        },
        {
            icon: <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 12L6.5 15M9 17.5H17M2.5 12L12.3595 1.79619C13.4211 0.734605 15.1422 0.734603 16.2038 1.79619C17.2654 2.85777 17.2654 4.57894 16.2038 5.64052L6 15.5L1 17L2.5 12Z" stroke="#292930" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>,
    ...
    return (
        <Form fields={formFields} title="Schedule form" submitFunc={submitFunc} />
    )
}
