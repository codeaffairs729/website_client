        ...
        <div className="teams">
          <div className="teams__center center">
            <div className="teams__head" data-aos="animation-scale-y">
              ...
              <h2 className="teams__title title">Helping world-className teams design faster together<span className="title__color">.</span></h2>
            </div>
                ...
                <div className="teams__container">
                  <div className="teams__slider js-teams-slider">
                    <div className="teams__slide" data-aos="animation-scale-y" data-aos-delay="200">
                      ...
                      <div className="teams__text">“ Collab is fast. Files are always up to date. <br/>It’s easy to share designs across the organization, so collaboration is easy ”</div>
                    ...
                    <div className="package__row">
                      <div className="package__details" data-aos data-aos-duration="600" data-aos-delay="400">
                        ...
                        <div className="package__btns">
                          <div className="package__arrows"><button className="package__arrow js-package-prev"><svg className="icon icon-arrow-prev">
                                <use xlinkHref="img/sprite.svg#icon-arrow-prev"></use>
                              </svg></button><button className="package__arrow js-package-next"><svg className="icon icon-arrow-next">
                                <use xlinkHref="img/sprite.svg#icon-arrow-next"></use>
                              </svg></button></div><a className="package__btn btn btn_purple" href="login.html">Get Started</a>
                        </div>
                      </div>
        ...
        <div className="design">
          <div className="design__center center">
            <div className="design__wrap" data-aos="animation-translate-y">
              ...
              <h2 className="design__title title">Enrich your design workflow<span className="title__color">.</span></h2>
                ...
                <div className="design__slider js-design-slider">
                  <div className="design__slide" data-aos="animation-translate-y" data-aos-delay="0">
                    ...
                    <div className="design__details">
                      ...
                      <div className="design__text">Use the smart color picker to easily select and apply colors.</div><a className="design__link" href="login.html">Get started<svg className="icon icon-arrow-right">
                  ...
                  <div className="design__slide" data-aos="animation-translate-y" data-aos-delay="200">
                    ...
                    <div className="design__details">
                      ...
                      <div className="design__text">Using the Component Builder with your projects.</div><a className="design__link" href="login.html">Get started<svg className="icon icon-arrow-right">
                          <use xlinkHref="img/sprite.svg#icon-arrow-right"></use>
                        </svg></a>
                    </div>
                  </div>
                  <div className="design__slide" data-aos="animation-translate-y" data-aos-delay="400">
                    ...
                    <div className="design__details">
                      ...
                      <div className="design__text">Deploy your projects more efficiently for web &amp; mobile.</div><a className="design__link" href="login.html">Get started<svg className="icon icon-arrow-right">
                          <use xlinkHref="img/sprite.svg#icon-arrow-right"></use>
                        </svg></a>
                    </div>
                  </div>
