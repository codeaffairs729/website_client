    ...
    const formFields = [
        {
            ...
            icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.69922 16.25C3.80373 14.4077 6.22445 13.1468 10.0011 13.1468C13.7778 13.1468 16.1985 14.4077 17.303 16.25M13.0011 6.75C13.0011 8.40685 11.658 9.75 10.0011 9.75C8.34426 9.75 7.00112 8.40685 7.00112 6.75C7.00112 5.09315 8.34426 3.75 10.0011 3.75C11.658 3.75 13.0011 5.09315 13.0011 6.75Z" stroke="#292930" strokeWidth="2" strokeLinecap="round" />
            </svg>,
            render: () => {
                return (<input
                    type="text"
        ...
        },
        {
            icon: <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.5 2.5L8.43079 6.60593C8.77323 6.84301 9.22676 6.84301 9.56921 6.60593L15.5 2.5M3 13H15C16.1046 13 17 12.1046 17 11V3C17 1.89543 16.1046 1 15 1H3C1.89543 1 1 1.89543 1 3V11C1 12.1046 1.89543 13 3 13Z" stroke="#292930" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>,
            render: () => {
                return (<input
                    type="email"
        ...
        },
        {
            icon: <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 12L6.5 15M9 17.5H17M2.5 12L12.3595 1.79619C13.4211 0.734605 15.1422 0.734603 16.2038 1.79619C17.2654 2.85777 17.2654 4.57894 16.2038 5.64052L6 15.5L1 17L2.5 12Z" stroke="#292930" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>,
